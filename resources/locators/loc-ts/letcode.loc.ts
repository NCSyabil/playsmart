...
export const example_letcode = {
  letcode_home_page: {
    link_explore_workspace: (page: Page) => page.getByRole('link', { name: 'Explore Workspace' })
	},
  letcode_edit_page: {
    input_fullname: (page: Page) => page.getByPlaceholder('Enter first & last name')
	},
  letcode_dropdowns_page: {
    select_fruit: (page: Page) => page.locator('select[id="fruits"]'),
	select_super_heros: (page: Page) => page.locator('select[id="superheros"]')
	}
};
